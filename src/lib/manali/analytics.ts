...
const BASE = { destination_id: 'manali', destination_type: 'domestic' as const }

export const manaliEvents = {
  ...
  riversideCottageView: () => trackEvent({ ...BASE, event_name: 'riverside_cottage_tier_view' }),
  ...
  seasonFilterClick: (month: string) => trackEvent({ ...BASE, event_name: 'manali_season_filter_click', month }),
  rohtangPermitView: () => trackEvent({ ...BASE, event_name: 'rohtang_permit_info_view' }),
  adventureCtaClick: () => trackEvent({ ...BASE, event_name: 'adventure_block_cta_click' }),
  romanticCtaClick: () => trackEvent({ ...BASE, event_name: 'romantic_block_cta_click' }),
