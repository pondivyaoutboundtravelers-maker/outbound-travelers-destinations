...
const BASE = { destination_id: 'lakshadweep', destination_type: 'domestic' as const }

export const lakshadweepEvents = {
  ...
  bangaramResortView: () => trackEvent({ ...BASE, event_name: 'bangaram_resort_tier_view' }),
  ...
  seasonFilterClick: (month: string) => trackEvent({ ...BASE, event_name: 'lakshadweep_season_filter_click', month }),
  permitInfoView: () => trackEvent({ ...BASE, event_name: 'permit_info_view' }),
  conservationRulesView: () => trackEvent({ ...BASE, event_name: 'conservation_rules_view' }),
  turtleSeasonCtaClick: () => trackEvent({ ...BASE, event_name: 'turtle_season_cta_click' }),
