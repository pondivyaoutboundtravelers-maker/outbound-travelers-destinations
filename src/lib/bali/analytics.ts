...
const BASE = { destination_id: 'bali', destination_type: 'international' as const }
...
export const baliEvents = {
  ...
  villaView: () => trackEvent({ ...BASE, event_name: 'villa_tier_view' }),
  ...
  seasonFilterClick: (month: string) => trackEvent({ ...BASE, event_name: 'bali_season_filter_click', month }),
