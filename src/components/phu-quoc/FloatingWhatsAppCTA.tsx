...
export default function FloatingWhatsAppCTA() {
  ...
  const handleOpen = () => {
    const text = encodeURIComponent(
      "Hi Outbound Travelers! I am looking at your premium Phu Quoc Tour Packages. Could you help me plan my customized quiet luxury trip?"
    );
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-neutral-300 font-light leading-relaxed">
                Xin Chào! Looking for a fast custom itinerary or pricing for Phu Quoc? Let's chat on WhatsApp.
              </p>
            </div>
          </motion.div>
        )}
