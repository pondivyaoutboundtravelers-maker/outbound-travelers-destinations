  ...
  return (
    <section className="py-12 md:py-16 px-4 md:px-8 max-w-7xl mx-auto">
      <h2 className="text-2xl md:text-3xl text-brand-navy font-bold text-center mb-10">
        Why Kashmir with Outbound Travelers
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {whyVisit.map((item, idx) => (
          <div
            key={idx}
            className="p-6 bg-cream rounded-xl border-l-4 border-kashmir-accent flex flex-col justify-start"
          >
            <div className="w-12 h-12 bg-kashmir-soft text-kashmir-accent rounded-full flex items-center justify-center mb-4">
              {icons[item.icon] || (
