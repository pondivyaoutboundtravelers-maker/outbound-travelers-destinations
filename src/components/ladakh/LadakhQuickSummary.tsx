...
export default function LadakhQuickSummary() {
  const { duration, bestSeason, startingFrom, tripTypes } = ladakhData.quickSummary
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0">
          {summaryItems.map((item, idx) => (
            ...
            >
              <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-[#E0E7FF] text-[#1F3A8A]">
                {item.icon}
              </div>
              <div>
