...
export default function ShimlaQuickSummary() {
  const { duration, bestSeason, startingFrom, tripTypes } = shimlaData.quickSummary
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0">
          {summaryItems.map((item, idx) => (
            ...
            >
              <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-[#E8EFE6] text-[#2F5233]">
                {item.icon}
              </div>
              <div>
