...
export default function WhatsAppFloatingButton({ whatsappUrl, accentColor }: WhatsAppFloatingButtonProps) {
  return (
    <a
      href={whatsappUrl}
      target="_blank"
      ...
      aria-label="Chat with our Kashmir Specialist on WhatsApp"
    >
