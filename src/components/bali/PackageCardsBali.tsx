...
export default function PackageCardsBali() {
  const [activeSlide, setActiveSlide] = useState(0)

  const handleEnquire = (pkg: Package) => {
    baliEvents.packageClick(pkg.id, pkg.name)
    window.dispatchEvent(new CustomEvent('openLeadForm'))
  }

  return (
    <section id="bali-packages" className="py-12 md:py-16 px-4 md:px-8 max-w-7xl mx-auto scroll-mt-20">
      ...
      <div className="md:hidden flex flex-col">
            ...
            >
              ...
              <div className="absolute inset-0 p-5 z-20 flex flex-col justify-between text-white">
                ...
                <div className="self-start">
                  <span className="bg-[#D97706] text-[9px] font-bold uppercase px-2 py-0.5 rounded tracking-wider">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-between items-center mt-3 pt-3 border-t border-white/20">
                    ...
                    <div className="flex gap-2">
                      <a
                        href={buildWhatsAppUrl(baliData.whatsapp.number, pkg.whatsappMessage)}
                        target="_blank"
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#D97706] text-white font-bold rounded-lg text-xs"
                      >
                        Enquire
                      </button>
                    </div>
        ...
        <div className="flex justify-center gap-1.5 mt-2">
          {baliData.packages.map((_, i) => (
            <div
              key={i}
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                i === activeSlide ? 'w-4 bg-[#D97706]' : 'bg-gray-300'
              }`}
            />
          ))}
        </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center mt-4 pt-4 border-t border-white/20">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => handleEnquire(pkg)}
                      className="px-5 h-10 bg-[#D97706] text-white font-bold rounded-lg text-sm transition-opacity hover:opacity-90"
                    >
                      Enquire Details
                    </button>
                  </div>
